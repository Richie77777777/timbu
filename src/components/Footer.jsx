...
<footer className="bg-brandbrown/80 text-white mt-10">
      ...
      <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
        ...
        <div className="col-span-2 lg:col-span-3 lg:flex lg:items-end">
          <form className="w-full">
            ...
            <div
              className="border rounded-full border-brandbrown p-2 focus-within:ring sm:flex sm:items-center sm:gap-4"
            >
              <input
                type="email"
                id="UserEmail"
        ...
        <div className="col-span-2 sm:col-span-1">
          ...
          <ul className="mt-6 space-y-4 text-sm">
            <li>
              <Link href="#" className=" transition hover:opacity-75"> About </Link>
            </li>

            <li>
              <Link href="#" className=" transition hover:opacity-75"> Meet the Team </Link>
            </li>
        ...
        <div className="col-span-2 sm:col-span-1">
          ...
          <ul className="mt-6 space-y-4 text-sm">
            <li>
              <Link href="#" className=" transition hover:opacity-75"> Contact </Link>
            </li>

            <li>
              <Link href="#" className=" transition hover:opacity-75"> FAQs </Link>
            </li>

            <li>
              <Link href="#" className=" transition hover:opacity-75"> Live Chat </Link>
            </li>
          </ul>
        </div>
        ...
        <div className="col-span-2 sm:col-span-1">
          ...
          <ul className="mt-6 space-y-4 text-sm">
            <li>
              <Link href="#" className=" transition hover:opacity-75"> Accessibility </Link>
            </li>

            <li>
              <Link href="#" className=" transition hover:opacity-75"> Returns Policy </Link>
            </li>

            <li>
              <Link href="#" className=" transition hover:opacity-75"> Refund Policy </Link>
            </li>

            <li>
              <Link href="#" className=" transition hover:opacity-75"> Hiring Statistics </Link>
            </li>
          </ul>
        </div>
